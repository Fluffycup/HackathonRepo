...
const main = async () => {
  ...
  const yourContract = await deploy("equityContract"); // <-- add in constructor args like line 19 vvvv
  // use for local token bridging
  //const PSC = await deploy("PseudoStableCoin") // <-- add in constructor args like line 19 vvvv
